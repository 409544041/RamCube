...
public partial class E_Dialogues : BGEntity
{
	...
	public List<E_AdditionalDialogues> f_AdditionalDialogues
	{
		get
		{
			var val = _f_AdditionalDialogues[Index];
			if(val==null || val.Count==0) return null;
			var _ufle12jhs_AdditionalDialogues = new List<E_AdditionalDialogues>();
			for (var i = 0; i < val.Count; i++) _ufle12jhs_AdditionalDialogues.Add((E_AdditionalDialogues) val[i]);
			return _ufle12jhs_AdditionalDialogues;
		}
	}
	public List<E_HintsDialogues> f_HintsDialogues
	{
		get
		{
			var val = _f_HintsDialogues[Index];
			if(val==null || val.Count==0) return null;
			var _ufle12jhs_HintsDialogues = new List<E_HintsDialogues>();
			for (var i = 0; i < val.Count; i++) _ufle12jhs_HintsDialogues.Add((E_HintsDialogues) val[i]);
			return _ufle12jhs_HintsDialogues;
		}
	}
	private static BansheeGz.BGDatabase.BGFieldEntityName _ufle12jhs77_f_name;
	public static BansheeGz.BGDatabase.BGFieldEntityName _f_name
	...
	private static BansheeGz.BGDatabase.BGFieldNested _ufle12jhs77_f_AdditionalDialogues;
	public static BansheeGz.BGDatabase.BGFieldNested _f_AdditionalDialogues
	{
		get
		{
			if(_ufle12jhs77_f_AdditionalDialogues==null || _ufle12jhs77_f_AdditionalDialogues.IsDeleted) _ufle12jhs77_f_AdditionalDialogues=(BansheeGz.BGDatabase.BGFieldNested) MetaDefault.GetField(new BGId(5650391854847053935UL,9041473667705462207UL));
			return _ufle12jhs77_f_AdditionalDialogues;
		}
	}
	private static BansheeGz.BGDatabase.BGFieldNested _ufle12jhs77_f_HintsDialogues;
	public static BansheeGz.BGDatabase.BGFieldNested _f_HintsDialogues
	{
		get
		{
			if(_ufle12jhs77_f_HintsDialogues==null || _ufle12jhs77_f_HintsDialogues.IsDeleted) _ufle12jhs77_f_HintsDialogues=(BansheeGz.BGDatabase.BGFieldNested) MetaDefault.GetField(new BGId(4758135799136454102UL,13727966505551805077UL));
...
public partial class E_Segments : BGEntity
{
	...
	public UnityEngine.Object f_DialogueObject
	{
		get
		{
			return _f_DialogueObject[Index];
		}
	}
	...
	private static BansheeGz.BGDatabase.BGFieldUnityObject _ufle12jhs77_f_DialogueObject;
	public static BansheeGz.BGDatabase.BGFieldUnityObject _f_DialogueObject
	{
		get
		{
			if(_ufle12jhs77_f_DialogueObject==null || _ufle12jhs77_f_DialogueObject.IsDeleted) _ufle12jhs77_f_DialogueObject=(BansheeGz.BGDatabase.BGFieldUnityObject) MetaDefault.GetField(new BGId(5042412784670426887UL,3798303333898769295UL));
			return _ufle12jhs77_f_DialogueObject;
		}
	}
...
public partial class E_QuestDialogues : BGEntity
{
	...
	public static BansheeGz.BGDatabase.BGFieldBool _f_Played
	{
		get
		{
			if(_ufle12jhs77_f_Played==null || _ufle12jhs77_f_Played.IsDeleted) _ufle12jhs77_f_Played=(BansheeGz.BGDatabase.BGFieldBool) MetaDefault.GetField(new BGId(5610891607708365715UL,14651620147662419376UL));
...
public partial class E_ReturnDialogues : BGEntity
{
	...
	public static BansheeGz.BGDatabase.BGFieldBool _f_Played
	{
		get
		{
			if(_ufle12jhs77_f_Played==null || _ufle12jhs77_f_Played.IsDeleted) _ufle12jhs77_f_Played=(BansheeGz.BGDatabase.BGFieldBool) MetaDefault.GetField(new BGId(4666056799245786167UL,9714396411379183293UL));
			return _ufle12jhs77_f_Played;
		}
	}
	private static readonly E_LevelData.Factory _factory0_PFS = new E_LevelData.Factory();
...
public partial class E_AdditionalDialogues : BGEntity
{
	...
	public class Factory : BGEntity.EntityFactory
	{
		public BGEntity NewEntity(BGMetaEntity meta)
		{
			return new E_AdditionalDialogues(meta);
		}
		public BGEntity NewEntity(BGMetaEntity meta, BGId id)
		{
			return new E_AdditionalDialogues(meta, id);
		}
	}
	private static BansheeGz.BGDatabase.BGMetaNested _metaDefault;
	public static BansheeGz.BGDatabase.BGMetaNested MetaDefault
	...
	public UnityEngine.ScriptableObject f_AdditionalDialogue
	{
		get
		{
			return _f_AdditionalDialogue[Index];
		}
	}
	private static BansheeGz.BGDatabase.BGFieldEntityName _ufle12jhs77_f_name;
	public static BansheeGz.BGDatabase.BGFieldEntityName _f_name
	{
		get
		{
			if(_ufle12jhs77_f_name==null || _ufle12jhs77_f_name.IsDeleted) _ufle12jhs77_f_name=(BansheeGz.BGDatabase.BGFieldEntityName) MetaDefault.GetField(new BGId(5030845089153911581UL,7056475815551447424UL));
			return _ufle12jhs77_f_name;
		}
	}
	private static BansheeGz.BGDatabase.BGFieldRelationSingle _ufle12jhs77_f_Dialogues;
	public static BansheeGz.BGDatabase.BGFieldRelationSingle _f_Dialogues
	{
		get
		{
			if(_ufle12jhs77_f_Dialogues==null || _ufle12jhs77_f_Dialogues.IsDeleted) _ufle12jhs77_f_Dialogues=(BansheeGz.BGDatabase.BGFieldRelationSingle) MetaDefault.GetField(new BGId(5113335154165853325UL,13117729812889025414UL));
			return _ufle12jhs77_f_Dialogues;
		}
	}
	private static BansheeGz.BGDatabase.BGFieldBool _ufle12jhs77_f_Played;
	public static BansheeGz.BGDatabase.BGFieldBool _f_Played
	{
		get
		{
			if(_ufle12jhs77_f_Played==null || _ufle12jhs77_f_Played.IsDeleted) _ufle12jhs77_f_Played=(BansheeGz.BGDatabase.BGFieldBool) MetaDefault.GetField(new BGId(5702079073593323336UL,2868386591389818757UL));
			return _ufle12jhs77_f_Played;
		}
	}
	private static BansheeGz.BGDatabase.BGFieldUnityScriptableObject _ufle12jhs77_f_AdditionalDialogue;
	public static BansheeGz.BGDatabase.BGFieldUnityScriptableObject _f_AdditionalDialogue
	{
		get
		{
			if(_ufle12jhs77_f_AdditionalDialogue==null || _ufle12jhs77_f_AdditionalDialogue.IsDeleted) _ufle12jhs77_f_AdditionalDialogue=(BansheeGz.BGDatabase.BGFieldUnityScriptableObject) MetaDefault.GetField(new BGId(5187168267212154598UL,8395711673383198627UL));
			return _ufle12jhs77_f_AdditionalDialogue;
		}
	}
	private static readonly E_LevelData.Factory _factory0_PFS = new E_LevelData.Factory();
	private static readonly E_Biome.Factory _factory1_PFS = new E_Biome.Factory();
	...
	private E_AdditionalDialogues(BGId id) : base(MetaDefault, id)
	{
	}
	private E_AdditionalDialogues(BGMetaEntity meta) : base(meta)
	{
	}
	private E_AdditionalDialogues(BGMetaEntity meta, BGId id) : base(meta, id)
	{
	}
	public static E_AdditionalDialogues FindEntity(Predicate<E_AdditionalDialogues> filter)
	{
		return MetaDefault.FindEntity(entity => filter==null || filter((E_AdditionalDialogues) entity)) as E_AdditionalDialogues;
	}
	public static List<E_AdditionalDialogues> FindEntities(Predicate<E_AdditionalDialogues> filter, List<E_AdditionalDialogues> result=null, Comparison<E_AdditionalDialogues> sort=null)
	{
		result = result ?? new List<E_AdditionalDialogues>();
		_find_Entities_Result.Clear();
		MetaDefault.FindEntities(filter == null ? (Predicate<BGEntity>) null: e => filter((E_AdditionalDialogues) e), _find_Entities_Result, sort == null ? (Comparison<BGEntity>) null : (e1, e2) => sort((E_AdditionalDialogues) e1, (E_AdditionalDialogues) e2));
		if (_find_Entities_Result.Count != 0)
		{
			for (var i = 0; i < _find_Entities_Result.Count; i++) result.Add((E_AdditionalDialogues) _find_Entities_Result[i]);
			_find_Entities_Result.Clear();
		}
		return result;
	}
	public static void ForEachEntity(Action<E_AdditionalDialogues> action, Predicate<E_AdditionalDialogues> filter=null, Comparison<E_AdditionalDialogues> sort=null)
	{
		MetaDefault.ForEachEntity(entity => action((E_AdditionalDialogues) entity), filter == null ? null : (Predicate<BGEntity>) (entity => filter((E_AdditionalDialogues) entity)), sort==null?(Comparison<BGEntity>) null:(e1,e2) => sort((E_AdditionalDialogues)e1,(E_AdditionalDialogues)e2));
	}
	public static E_AdditionalDialogues GetEntity(BGId entityId)
	{
		return (E_AdditionalDialogues) MetaDefault.GetEntity(entityId);
	}
	public static E_AdditionalDialogues GetEntity(int index)
	{
		return (E_AdditionalDialogues) MetaDefault[index];
	}
	public static E_AdditionalDialogues GetEntity(string entityName)
	{
		return (E_AdditionalDialogues) MetaDefault.GetEntity(entityName);
	}
	public static E_AdditionalDialogues NewEntity()
	{
		return (E_AdditionalDialogues) MetaDefault.NewEntity();
	}
	public static E_AdditionalDialogues NewEntity(E_Dialogues owner)
	{
		return (E_AdditionalDialogues) MetaDefault.NewEntity(owner);
	}
}
...
public partial class E_QuestWaitingDialogues : BGEntity
{
	...
	public static BansheeGz.BGDatabase.BGFieldBool _f_Played
	{
		get
		{
			if(_ufle12jhs77_f_Played==null || _ufle12jhs77_f_Played.IsDeleted) _ufle12jhs77_f_Played=(BansheeGz.BGDatabase.BGFieldBool) MetaDefault.GetField(new BGId(5137367128565016329UL,14923122269115018941UL));
			return _ufle12jhs77_f_Played;
		}
	}
	private static readonly E_LevelData.Factory _factory0_PFS = new E_LevelData.Factory();
...
public partial class E_HintsDialogues : BGEntity
{
	...
	public class Factory : BGEntity.EntityFactory
	{
		public BGEntity NewEntity(BGMetaEntity meta)
		{
			return new E_HintsDialogues(meta);
		}
		public BGEntity NewEntity(BGMetaEntity meta, BGId id)
		{
			return new E_HintsDialogues(meta, id);
		}
	}
	private static BansheeGz.BGDatabase.BGMetaNested _metaDefault;
	public static BansheeGz.BGDatabase.BGMetaNested MetaDefault
	...
	public static BansheeGz.BGDatabase.BGFieldEntityName _f_name
	{
		get
		{
			if(_ufle12jhs77_f_name==null || _ufle12jhs77_f_name.IsDeleted) _ufle12jhs77_f_name=(BansheeGz.BGDatabase.BGFieldEntityName) MetaDefault.GetField(new BGId(5636797247828071848UL,5425825514234674360UL));
			return _ufle12jhs77_f_name;
		}
	}
	private static BansheeGz.BGDatabase.BGFieldRelationSingle _ufle12jhs77_f_Dialogues;
	public static BansheeGz.BGDatabase.BGFieldRelationSingle _f_Dialogues
	{
		get
		{
			if(_ufle12jhs77_f_Dialogues==null || _ufle12jhs77_f_Dialogues.IsDeleted) _ufle12jhs77_f_Dialogues=(BansheeGz.BGDatabase.BGFieldRelationSingle) MetaDefault.GetField(new BGId(4915148993695650078UL,4153087360300858503UL));
			return _ufle12jhs77_f_Dialogues;
		}
	}
	private static BansheeGz.BGDatabase.BGFieldUnityScriptableObject _ufle12jhs77_f_HintsDialogue;
	public static BansheeGz.BGDatabase.BGFieldUnityScriptableObject _f_HintsDialogue
	{
		get
		{
			if(_ufle12jhs77_f_HintsDialogue==null || _ufle12jhs77_f_HintsDialogue.IsDeleted) _ufle12jhs77_f_HintsDialogue=(BansheeGz.BGDatabase.BGFieldUnityScriptableObject) MetaDefault.GetField(new BGId(4784041791580299616UL,15244286505022620082UL));
			return _ufle12jhs77_f_HintsDialogue;
		}
	}
	private static readonly E_LevelData.Factory _factory0_PFS = new E_LevelData.Factory();
	private static readonly E_Biome.Factory _factory1_PFS = new E_Biome.Factory();
	...
	private E_HintsDialogues(BGId id) : base(MetaDefault, id)
	{
	}
	private E_HintsDialogues(BGMetaEntity meta) : base(meta)
	{
	}
	private E_HintsDialogues(BGMetaEntity meta, BGId id) : base(meta, id)
	{
	}
	public static E_HintsDialogues FindEntity(Predicate<E_HintsDialogues> filter)
	{
		return MetaDefault.FindEntity(entity => filter==null || filter((E_HintsDialogues) entity)) as E_HintsDialogues;
	}
	public static List<E_HintsDialogues> FindEntities(Predicate<E_HintsDialogues> filter, List<E_HintsDialogues> result=null, Comparison<E_HintsDialogues> sort=null)
	{
		result = result ?? new List<E_HintsDialogues>();
		_find_Entities_Result.Clear();
		MetaDefault.FindEntities(filter == null ? (Predicate<BGEntity>) null: e => filter((E_HintsDialogues) e), _find_Entities_Result, sort == null ? (Comparison<BGEntity>) null : (e1, e2) => sort((E_HintsDialogues) e1, (E_HintsDialogues) e2));
		if (_find_Entities_Result.Count != 0)
		{
			for (var i = 0; i < _find_Entities_Result.Count; i++) result.Add((E_HintsDialogues) _find_Entities_Result[i]);
			_find_Entities_Result.Clear();
		}
		return result;
	}
	public static void ForEachEntity(Action<E_HintsDialogues> action, Predicate<E_HintsDialogues> filter=null, Comparison<E_HintsDialogues> sort=null)
	{
		MetaDefault.ForEachEntity(entity => action((E_HintsDialogues) entity), filter == null ? null : (Predicate<BGEntity>) (entity => filter((E_HintsDialogues) entity)), sort==null?(Comparison<BGEntity>) null:(e1,e2) => sort((E_HintsDialogues)e1,(E_HintsDialogues)e2));
	}
	public static E_HintsDialogues GetEntity(BGId entityId)
	{
		return (E_HintsDialogues) MetaDefault.GetEntity(entityId);
	}
	public static E_HintsDialogues GetEntity(int index)
	{
		return (E_HintsDialogues) MetaDefault[index];
	}
	public static E_HintsDialogues GetEntity(string entityName)
	{
		return (E_HintsDialogues) MetaDefault.GetEntity(entityName);
	}
	public static E_HintsDialogues NewEntity()
	{
		return (E_HintsDialogues) MetaDefault.NewEntity();
	}
	public static E_HintsDialogues NewEntity(E_Dialogues owner)
	{
		return (E_HintsDialogues) MetaDefault.NewEntity(owner);
	}
}
