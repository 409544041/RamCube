...
[AddComponentMenu("BansheeGz/Generated/M_MapBiomeIdentifier")]
public partial class M_MapBiomeIdentifier : BGEntityGo
{
	...
	public UnityEngine.Vector2 f_MinzMaxZ
	{
		get
		{
			return _f_MinzMaxZ[Entity.Index];
		}
		set
		{
			_f_MinzMaxZ[Entity.Index] = value;
		}
	}
	...
	private static BansheeGz.BGDatabase.BGFieldVector2 __f_MinzMaxZ;
	public static BansheeGz.BGDatabase.BGFieldVector2 _f_MinzMaxZ
	{
		get
		{
			if(__f_MinzMaxZ==null || __f_MinzMaxZ.IsDeleted) __f_MinzMaxZ=(BansheeGz.BGDatabase.BGFieldVector2) MetaDefault.GetField(new BGId(4963201344065341682UL,2249124763249448884UL));
			return __f_MinzMaxZ;
		}
	}
}
